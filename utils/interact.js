...
const contract = require("../artifacts/contracts/NewWorld.sol/NewWorld.json");
const contractAddress = "0x57508b3995E618E07A52B7A33134954e7eADEFEB";
...
export const connectWallet = async () => {
  ...
  export const mintNFT = async (mintAmount) => {
    ...
    const transactionParameters = {
      ...
      gasLimit: "0",
      data: nftContract.methods.mintNewWorld(mintAmount).encodeABI(), //make call to NFT smart contract
    };
